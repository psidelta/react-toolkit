...
function themeFileTemplate(config) {
  ...
  return `
$ZIPPY_${componentNameUnderscore}_THEME_NAME: ${themeName};
$ZIPPY_${componentNameUnderscore}_MAIN_COLOR: ${primaryColor};
$ZIPPY_${componentNameUnderscore}_SECONDARY_COLOR: ${secondaryColor};
