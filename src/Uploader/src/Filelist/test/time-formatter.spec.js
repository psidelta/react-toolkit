...
describe('timeFormatter', () => {
  it('should be a function', () => {
    expect(timeFormatter).to.be.instanceOf(Function);
  });
  ...
  describe("when between 1minutes and 59minutes 59seconds 999ms", () => {
    ...
    it('should show minutes, seconds and milliseconds', () => {
      const msText = timeFormatter(60*1000*3+45*1000+123, {showMilliseconds:true});
      expect(msText).to.equal('3m 45s 123ms');
    });

    it('should show minutes only', () => {
      const msText = timeFormatter(60*1000*3+45*1000+123, {showSeconds:false});
  ...
  describe("with days", () => {
    ...
    const time = 1 * 24*60*60*1000 + 12 * 60*60*1000 + 33 * 60*1000 + 45*1000 + 123;
