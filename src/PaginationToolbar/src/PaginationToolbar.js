...
const CLASS_NAME = 'zippy-react-pagination-toolbar';
...
export default class ZippyPaginationToolbar extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const domProps = {
      ...cleanProps(this.props, ZippyPaginationToolbar.propTypes),
      className,
      theme
    };
    ...
    return (
      <ToolBar {...domProps} useTransformOnScroll={false}>
