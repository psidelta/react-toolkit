        ...
        return (
            <div>
             ...
             <p>Dolorem ipsam minus consequatur occaecati voluptatibus. Alias corporis facilis tempora illo sint et. Harum dolor ut saepe qui qui pariatur. Qui est quidem quia et sed id aut et. Facere enim ipsa ut sapiente adipisci quia sint.</p>
                      ...
                      <div style={{width:300}}>
                        <div style={{display:'flex'}}><button onClick={()=>(this.updateActiveIndex())}>ActiveIndex</button><input ref='boundActiveIndex' onChange={(ev)=>{this.setState({activeIndexText:ev.target.value})}} style={{width:100}} value={this.state.activeIndexText}/></div>
