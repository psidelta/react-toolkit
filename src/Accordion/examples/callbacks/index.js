    ...
    render() {
        return (
            <div>
                ...
                <p>The expand/collapse interaction has callbacks. Check the console on this page.</p>
             ...
             <p>Dolorem ipsam minus consequatur occaecati voluptatibus. Alias corporis facilis tempora illo sint et. Harum dolor ut saepe qui qui pariatur. Qui est quidem quia et sed id aut et. Facere enim ipsa ut sapiente adipisci quia sint.</p>
                           ...
                           <div
                            ...
                            tabProps={{
                                onExpand: ()=>(console.log('tab expanded with custom callback')),
                                onCollapse: ()=>(console.log('tab collapsed with custom callback'))
                            }}
                            >
                             <h2>This tab has callbacks set to self</h2>
                             <p>It will trigger it's own callbacks as well as the accordion ones</p>
                           </div>
