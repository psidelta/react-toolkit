...
export default class Methods extends Component {
    ...
    render() {
        return (
            <div>
                <h2>Methods</h2>
                <p>Controlling programatically which tabs are open and which are closed</p>
             ...
             <p>Dolorem ipsam minus consequatur occaecati voluptatibus. Alias corporis facilis tempora illo sint et. Harum dolor ut saepe qui qui pariatur. Qui est quidem quia et sed id aut et. Facere enim ipsa ut sapiente adipisci quia sint.</p>
                      ...
                      <div style={{width:300}}>
                          <div style={{display:'flex'}}><button onClick={()=>(this.onExpandAt())}>Expand At</button><input ref='expandAtInput' style={{width:50}} type='number'/></div>
                          <div style={{display:'flex'}}><button onClick={()=>(this.onCollapseAt())}>Collapse At</button><input ref='collapseAtInput' style={{width:50}} type='number'/></div>
                          <div style={{display:'flex'}}><button onClick={()=>(this.onExpandAll())}>Expand All</button></div>
                          <div style={{display:'flex'}}><button onClick={()=>(this.onCollapseAll())}>Collpase All</button></div>
                      </div>
                  </div>
