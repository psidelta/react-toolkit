...
describe('activeItem', () => {
  it('should work controlled and uncontrolled behaviour of active tag', () => {
    ...
    const wrapper = mount(<Combo defaultActiveItem={20} onActiveItemChange={onActiveItemChange} />)
  ...
  it('ArrowDown it should make first item active if the list is open and there is no active item', () => {
    ...
    const wrapper = shallow(<Combo dataSource={dataSource} expanded defaultActiveItem={null} />)
  ...
  it('ArrowDown navigates to next item', () => {
    ...
    const wrapper = shallow(<Combo dataSource={dataSource} expanded defaultActiveItem={1} />)
    wrapper.simulate('keyDown', { key: 'ArrowDown' })
  ...
  it('ArrowUp navigates to previous item', () => {
    ...
    const wrapper = shallow(<Combo dataSource={dataSource} expanded defaultActiveItem={2} />)
    wrapper.simulate('keyDown', { key: 'ArrowUp' })
    expect(wrapper.instance().getActiveItem()).to.equal(1)
  })
