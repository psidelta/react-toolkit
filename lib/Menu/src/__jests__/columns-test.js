...
describe('columns', function () {
  it('default should render 1 column', function () {
    ...
    expect(wrapper.find(_MenuItem2.default).find(_MenuItemCell2.default).length).toBe(1);
  });
  ...
  it('renders custom columns', function () {
    ...
    expect(wrapper.find(_MenuItem2.default).find(_MenuItemCell2.default).length).toBe(2);
  });
