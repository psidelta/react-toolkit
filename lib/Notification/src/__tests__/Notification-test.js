...
describe('Notification', function () {
  describe('autoHideDelay', function () {
    it('calls onHide after a delay', function () {
  ...
  describe('classname', function () {
    it('adds correct stacking className', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification--stacking-left-top')).to.have.length(1);
    });
    it('adds --move-transition clasname when true', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification--move-transition')).to.have.length(1);
    });
    it('adds non-blocking clasname when true', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification--non-blocking')).to.have.length(1);
    });
  });
  ...
  describe('style', function () {
    it('adds style prop', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification').at(0).props().style.color).to.equal('red');
    });
  });
  ...
  describe('border', function () {
    it('adds border on notification', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification').at(0).props().style.border).to.equal('1px solid red');
    });
  });
  ...
  describe('borderRadius', function () {
    it('adds borderRadius on notification', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification').at(0).props().style.borderRadius).to.equal('1px solid red');
    });
  });
  ...
  describe('background', function () {
    it('adds background on notification', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification').at(0).props().style.background).to.equal('blue');
    });
  });
  ...
  describe('padding', function () {
    it('adds padding on notification', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification').at(0).props().style.padding).to.equal(20);
    });
  });
  ...
  describe('width', function () {
    it('adds width on notification', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification').at(0).props().style.width).to.equal(20);
    });
  });
  ...
  describe('height', function () {
    it('adds height on notification', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification').at(0).props().style.height).to.equal(20);
    });
  });
  ...
  describe('opacity', function () {
    it('adds opacity on notification', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification').at(0).props().style.opacity).to.equal(20);
    });
  });

  xdescribe('height and width', function () {
    it('if both are set it should not call onSizeChange', function () {
      var onSizeChange = sinon.spy();
  ...
  describe('minSize, maxSize', function () {
    it('adds correct minWidth, minHeight, maxWidth, maxHeight', function () {
      ...
      expect({ minWidth: minWidth, maxWidth: maxWidth, minHeight: minHeight, maxHeight: maxHeight }).to.deep.equal({
        minWidth: 20,
        maxWidth: 20,
        minHeight: 30,
        maxHeight: 30
  ...
  describe('shadow', function () {
    it('adds correct minWidth, minHeight, maxWidth, maxHeight', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification--shadow')).to.have.length(1);
    });
  });
  ...
  describe('clearOpacityOnMouseEnter', function () {
    it('removes opacity when mouse enters notification', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification').at(0).props().style.opacity).to.equal(3);

      wrapper.find('.zippy-react-toolkit-notification').at(0).simulate('mouseEnter');
      expect(wrapper.find('.zippy-react-toolkit-notification').at(0).props().style.opacity).to.equal(1);
    });
  });
  ...
  describe('closeButton', function () {
    it('renders closeButton when true', function () {
      ...
      expect(wrapper.find('.zippy-react-toolkit-notification__close-button')).to.have.length(1);
      expect(wrapper.find(_CloseButton2.default)).to.have.length(1);
    });
