...
exports.getDecimalDelimiterPosition = exports.countDecimalDigits = undefined;
exports.default = getTransformedStringValues;

var _getDecimalDelimiter = require('./get-decimal-delimiter');

var _getDecimalDelimiter2 = _interopRequireDefault(_getDecimalDelimiter);

var _getDigitGroupDelimiter = require('./get-digit-group-delimiter');
...
var getDecimalDelimiterPosition = function getDecimalDelimiterPosition(string, decimalDelimiter) {
...
function getTransformedStringValues(stringInput) {
  ...
  var _internalApi$getDecim = internalApi.getDecimalDelimiter,
      getDecimalDelimiter = _internalApi$getDecim === undefined ? _getDecimalDelimiter2.default : _internalApi$getDecim,
      _internalApi$getDigit = internalApi.getDigitGroupDelimiter,
      getDigitGroupDelimiter = _internalApi$getDigit === undefined ? _getDigitGroupDelimiter2.default : _internalApi$getDigit,
      _internalApi$convertS = internalApi.convertStringToNumber,
      convertStringToNumber = _internalApi$convertS === undefined ? _convertStringToNumber2.default : _internalApi$convertS;
