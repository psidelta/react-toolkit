...
var ZippyFlexItem = function (_Component) {
  _inherits(ZippyFlexItem, _Component);

  function ZippyFlexItem() {
    _classCallCheck(this, ZippyFlexItem);

    return _possibleConstructorReturn(this, (ZippyFlexItem.__proto__ || Object.getPrototypeOf(ZippyFlexItem)).apply(this, arguments));
  }

  _createClass(ZippyFlexItem, [{
    ...
    value: function render() {
      ...
      var className = (0, _join2.default)('zippy-react-toolkit-flex-item', (0, _props2className2.default)(props));
