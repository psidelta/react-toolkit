...
var ZippySvgLoader = function (_React$Component) {
  _inherits(ZippySvgLoader, _React$Component);

  function ZippySvgLoader() {
    _classCallCheck(this, ZippySvgLoader);

    return _possibleConstructorReturn(this, (ZippySvgLoader.__proto__ || Object.getPrototypeOf(ZippySvgLoader)).apply(this, arguments));
  }

  _createClass(ZippySvgLoader, [{
    key: 'render',
    value: function render() {
      ...
      var className = (0, _join2.default)(props.className, DEFAULT_CLASS_NAME, DEFAULT_CLASS_NAME + '--svg', props.theme && DEFAULT_CLASS_NAME + '--theme-' + props.theme);
      return _react2.default.createElement(
        'div',
        { style: style, className: className },
        _react2.default.createElement(
          'svg',
          { height: props.size, viewBox: '0 0 24 24', width: props.size },
  ...
  return ZippySvgLoader;
}(_react2.default.Component);

exports.default = ZippySvgLoader;
