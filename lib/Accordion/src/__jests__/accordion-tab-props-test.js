...
describe('Accordion tab style props', function () {
  ...
  describe('tabClassName', function () {
    it('should add tabClassName to all tabs', function () {
      expect(tabContentComponents.at(0).prop('wrapperClassName')).toEqual(CUSTOM_CLASS_NAME);
      expect(tabContentComponents.at(1).prop('wrapperClassName')).toEqual(CUSTOM_CLASS_NAME);
      expect(tabContentComponents.at(2).prop('wrapperClassName')).toEqual(CUSTOM_CLASS_NAME + ' ' + CUSTOM_CLASS_NAME_2);
    });
  });
});