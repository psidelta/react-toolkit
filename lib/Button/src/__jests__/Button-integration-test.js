...
describe('Button verticalAlign', function () {
  it('should add the correct className', function () {
    ...
    expect((0, _reactDom.findDOMNode)(button).className).toContain('--vertical-align-middle');

    button.unmount();
  });
});

xdescribe('Button icon', function () {
...
xdescribe('Button wrap', function () {
...
xdescribe('Button overflow', function () {
