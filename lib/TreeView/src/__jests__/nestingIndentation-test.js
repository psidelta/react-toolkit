...
describe('nestingIndentation', function () {
  it('should add paddingLeft on contentStyle', function () {
    ...
    expect(wrapper.find(_Node2.default).first().props().contentStyle.paddingLeft).toEqual(20);
  });
  ...
  it('should add padddingRight to contentStyle if rtl', function () {
    ...
    expect(wrapper.find(_Node2.default).first().props().contentStyle.paddingRight).toEqual(20);
  });
});