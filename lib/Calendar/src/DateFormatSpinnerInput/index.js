...
var DateFormatSpinnerInput = function (_Component) {
  ...
  _createClass(DateFormatSpinnerInput, [{
    ...
    value: function render() {
      ...
      var inputProps = input ? (0, _assign2.default)({}, input.props) : {};
      ...
      this.arrows = {
        1: _react2.default.createElement(
          'svg',
          { height: arrowSize, viewBox: '2 2 20 20', width: arrowSize },
      ...
      var className = (0, _join2.default)(props.className, rootClassName, this.state.focused ? rootClassName + '-spinner--focused' : rootClassName + '-spinner', disabled && rootClassName + '--disabled', this.isFocused() && rootClassName + '--focused', rootClassName + '--theme-' + props.theme);

      return _react2.default.createElement(
        _Flex.Flex,
        { inline: true, row: true, className: className, disabled: props.disabled },
...
DateFormatSpinnerInput.propTypes = {
  ...
  firstStepDelay: _propTypes2.default.number,
  secondStepDelay: _propTypes2.default.number,
  ...
  isDateInput: _propTypes2.default.bool,
