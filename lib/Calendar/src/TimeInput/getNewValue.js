...
var getValueOnDelete = function getValueOnDelete(_ref4) {
  ...
  if (selectedValue) {
    ...
    value = replaceBetween({ value: oldValue, start: start, end: end, str: _replacement });
  ...
  value = replaceAt({ value: oldValue, index: index, str: replacement });
...
var getTimePartAt = function getTimePartAt(index, _ref6) {
  ...
  return (0, _assign2.default)({}, TIME_PARTS[hours24 ? 24 : 12][index]);
};
...
var getValueOnDirection = function getValueOnDirection(_ref8) {
  ...
  hours = (0, _leftPad2.default)((0, _clamp.clampHour)(hours * 1, {
    circular: circular,
