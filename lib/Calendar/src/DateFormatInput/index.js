...
var DateFormatInput = function (_Component) {
  ...
  _createClass(DateFormatInput, [{
    ...
    value: function render() {
      ...
      var inputProps = (0, _assign2.default)({}, props);
    ...
    value: function setStateValue(value, callback, _ref) {
      ...
      if (!dateMoment.isValid()) {
        ...
        if (currentPosition.format == 'MM') {
          ...
          // updating the day
          dateMoment = dir > 0 ? // we've gone with +1 beyond max, so reset to 1
          this.toMoment(oldValue).date(1) : // we've gone with -1 beyond max, so reset to max of month
...
DateFormatInput.defaultProps = {
  rootClassName: 'zippy-react-toolkit-calendar__input',
  theme: 'default',
  isDateInput: true,
