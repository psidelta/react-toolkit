...
var _renderFooter = function renderFooter(props, buttonHandlers) {
  ...
  if (childFooter) {
    if (renderFooter) {
      return renderFooter((0, _assign2.default)({}, childFooter.props, footerProps));
    }
...
var MonthView = function (_Component) {
  ...
  _createClass(MonthView, [{
    ...
    value: function prepareClassName(props) {
      return (0, _join2.default)(props.className, props.rootClassName, props.rootClassName + '--theme-' + props.theme, props.size === undefined ? props.rootClassName + '-relative' : null);
    }
  }, {
    key: 'prepareProps',
    ...
    value: function preparePrevNextClassName(timestamp, props) {
      ...
      return (0, _join2.default)(timestamp == TODAY && rootClassName + '-day--today', props.highlightToday && timestamp == TODAY && rootClassName + '-day--today-highlight', before && rootClassName + '-day--prev-month', before && !props.showDaysBeforeMonth && rootClassName + '-day--hidden', after && rootClassName + '-day--next-month', after && !props.showDaysAfterMonth && rootClassName + '-day--hidden', thisMonth && rootClassName + '-day--this-month');
    }
  }, {
    ...
    value: function prepareWeekendClassName(dateMoment, _ref) {
      ...
      if (weekDay === 0 /* Sunday */ || weekDay === 6 /* Saturday */) {
          return (0, _join2.default)(rootClassName + '-day--weekend', highlightWeekends && rootClassName + '-day--weekend-highlight');
        }
    ...
    value: function prepareDayProps(renderDayProps, props) {
      ...
      (0, _assign2.default)(result, minMaxProps, rangeProps, {
        children: _react2.default.createElement(
          'div',
          { className: rootClassName + '-day-text' },
          renderDayProps.day
        ),
        className: (0, _join2.default)([minMaxProps.className, rangeProps.className, prevNextClassName, weekendClassName, timestamp == currentTimestamp ? rootClassName + '-day--value' : null, timestamp == props.activeDate ? rootClassName + '-day--active' : null, className])
      });
    ...
    value: function renderDay(renderProps) {
      ...
      (0, _assign2.default)(renderProps, this.prepareDayProps(renderProps, props));
      ...
      if (renderProps.disabled) {
        renderProps.className = (0, _join2.default)(rootClassName + '-day--disabled', renderProps.className);
      } else {
    ...
    value: function render() {
      ...
      var basicViewProps = (0, _assign2.default)({}, props);
    ...
    value: function renderFooter(props) {
      return _renderFooter((0, _assign2.default)({}, props, {
    ...
    value: function renderNavBar(props) {
      ...
      var navBarProps = (0, _assign2.default)({}, childNavBar.props, (0, _assignDefined2.default)({
        viewMoment: props.viewMoment,
        date: props.moment,
        theme: theme,
        ref: ref,
...
MonthView.defaultProps = {
  rootClassName: 'zippy-react-toolkit-calendar__month-view',
...
MonthView.propTypes = {
  ...
  footerClearDate: _propTypes2.default.object,

  partialRange: _propTypes2.default.bool,

  activateOnHover: _propTypes2.default.bool,
  constrainActiveInView: _propTypes2.default.bool,

  showDaysBeforeMonth: _propTypes2.default.bool,
  showDaysAfterMonth: _propTypes2.default.bool,
  ...
  getTransitionTime: _propTypes2.default.func,
  cleanup: _propTypes2.default.func,
  navigate: _propTypes2.default.func,
  onRangeChange: _propTypes2.default.func,
  onHoverRangeChange: _propTypes2.default.func, // x
  renderNavBar: _propTypes2.default.func,
  ...
  dayPropsMap: _propTypes2.default.object,

  insideMultiView: _propTypes2.default.bool,
  insideField: _propTypes2.default.bool,
  enableMonthDecadeView: _propTypes2.default.bool,
  focusOnNavMouseDown: _propTypes2.default.bool,
  focusOnFooterMouseDown: _propTypes2.default.bool,
  maxConstrained: _propTypes2.default.bool,
  minConstrained: _propTypes2.default.bool,
  ...
  navBarArrows: _propTypes2.default.shape({
  ...
  rangeStart: DateType,
  range: _propTypes2.default.arrayOf(DateType),
  defaultRange: _propTypes2.default.arrayOf(DateType),
  hoverRange: _propTypes2.default.arrayOf(DateType),
  defaultHoverRange: _propTypes2.default.arrayOf(DateType),
  minDate: DateType,
  maxDate: DateType,
  viewDate: DateType,
