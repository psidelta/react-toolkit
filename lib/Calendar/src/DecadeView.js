...
var prepareDateProps = function prepareDateProps(props, state) {
  ...
  (0, _assign2.default)(result, prepareMinMax(props));
...
var DecadeView = function (_Component) {
  ...
  _createClass(DecadeView, [{
    ...
    value: function render() {
      ...
      (0, _assign2.default)(props, dateProps);
      ...
      if (props.navigation) {
        ...
        children = [this.renderNav(-1), _react2.default.createElement(_Flex.Flex, {
          key: 'year_view',
          inline: true,
          flex: true,
          column: true,
    ...
    value: function renderNav(dir) {
      ...
      var className = (0, _join2.default)(rootClassName + '-arrow', rootClassName + '-arrow--' + name, disabled && rootClassName + '-arrow--disabled');
      ...
      return _react2.default.createElement('div', _extends({ key: 'nav_arrow_' + dir }, arrowProps));
    }
  }, {
    key: 'renderYears',
    ...
    value: function renderYear(dateMoment) {
      ...
      var className = (0, _join2.default)(rootClassName + '-year', isActiveDate && rootClassName + '-year--active', isValue && rootClassName + '-year--value', props.minDate != null && timestamp < props.minDate && rootClassName + '-year--disabled', props.maxDate != null && timestamp > props.maxDate && rootClassName + '-year--disabled');
      ...
      return _react2.default.createElement(
        _Flex.Item,
        { key: yearText, className: className, onClick: onClick },
        yearText
      );
    }
  }, {
...
DecadeView.propTypes = {
  isDecadeView: _propTypes2.default.bool,
  rootClassName: _propTypes2.default.string,
  navigation: _propTypes2.default.bool,
  constrainViewDate: _propTypes2.default.bool,
  arrows: _propTypes2.default.object,
  navKeys: _propTypes2.default.object,
  theme: _propTypes2.default.string,
  yearFormat: _propTypes2.default.string,
  dateFormat: _propTypes2.default.string,
  perRow: _propTypes2.default.number,
  minDate: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.object]),
  maxDate: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.object]),
  viewDate: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.object]),
  date: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.object]),
  defaultDate: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.object]),
  viewMoment: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.object]),
  moment: _propTypes2.default.object,
  minDateMoment: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.object]),
  maxDateMoment: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.object]),

  onlyCompareYear: _propTypes2.default.bool,
  adjustDateStartOf: _propTypes2.default.string,
  adjustMinDateStartOf: _propTypes2.default.string,
  adjustMaxDateStartOf: _propTypes2.default.string,

  activeDate: _propTypes2.default.number,
  ...
  renderNavigation: _propTypes2.default.func,
