...
var MINUTES = Array.apply(undefined, _toConsumableArray(new Array(60))).map(function (_, index) {
  return index;
});
...
var rotateTickStyle = function rotateTickStyle(tick, _ref, totalSize, offset) {
  ...
  var result = (0, _assign2.default)({}, transformStyle);
  var deg = tick * 6;
...
var Clock = function (_Component) {
  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      ...
      var className = (0, _join2.default)(props.className, props.rootClassName, props.rootClassName + '--theme-' + props.theme);
      ...
      var style = (0, _assign2.default)(defaultStyle, props.style, {
        width: width,
        height: height,
      ...
      return _react2.default.createElement(
        'div',
        _extends({}, divProps, { className: className, style: style }),
        this.renderCenter(),
        ...
        this.props.size == 'auto' && _react2.default.createElement(_NotifyResize.NotifyResize, { notifyOnMount: true, onResize: this.onResize })
      );
    }
  }, {
    key: 'renderCenter',
    ...
    value: function renderHand(name, value) {
      ...
      var height = props[name + 'HandHeight'] || props.handHeight || size / 2 - props[name + 'HandDiff'] / 2;
      ...
      var className = (0, _join2.default)(props.rootClassName + '-hand', props.rootClassName + '-hand-' + name);
    ...
    value: function renderTick(tick) {
      ...
      var className = (0, _join2.default)(rootClassName + '-tick', rootClassName + '-tick--' + sizeName);
...
Clock.defaultProps = {
  rootClassName: 'zippy-react-toolkit-calendar__clock',
  centerSize: null,
...
Clock.propTypes = (_Clock$propTypes = {
  ...
  centerSize: _propTypes2.default.number,
  centerOverlaySize: _propTypes2.default.number,
  defaultSeconds: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.string]),
  seconds: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.string]),
  defaultTime: _propTypes2.default.oneOfType([_propTypes2.default.object, _propTypes2.default.string]),
  time: _propTypes2.default.oneOfType([_propTypes2.default.object, _propTypes2.default.string]),

  size: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.string]),
  theme: _propTypes2.default.string,

  showSecondsHand: _propTypes2.default.bool,
  showHoursHand: _propTypes2.default.bool,
  showMinutesHand: _propTypes2.default.bool,

  run: _propTypes2.default.bool,
  updateInterval: _propTypes2.default.number,

  handWidth: _propTypes2.default.number,
  secondHandWidth: _propTypes2.default.number,
  handOffset: _propTypes2.default.number,
  bigTickOffset: _propTypes2.default.number,

  hourHandDiff: _propTypes2.default.number,
  minuteHandDiff: _propTypes2.default.number,
  secondHandDiff: _propTypes2.default.number,

  borderColor: _propTypes2.default.string,
  handHeight: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),

  tickWidth: _propTypes2.default.number,
  bigTickWidth: _propTypes2.default.number,
  smallTickWidth: _propTypes2.default.number,
  tickOffset: _propTypes2.default.number,
  smallTickOffset: _propTypes2.default.number,
  smallTickHeight: _propTypes2.default.number,
  bigTickHeight: _propTypes2.default.number,
  tickHeight: _propTypes2.default.number,

  color: _propTypes2.default.string,
  borderWidth: _propTypes2.default.number,
  showSmallTicks: _propTypes2.default.bool,
  isDatePickerClock: _propTypes2.default.bool,

  renderTick: _propTypes2.default.func,

  onSecondsChange: _propTypes2.default.func,
  onTimeChange: _propTypes2.default.func
}, _defineProperty(_Clock$propTypes, 'onTimeChange', _propTypes2.default.func), _defineProperty(_Clock$propTypes, 'cleanup', _propTypes2.default.func), _Clock$propTypes);