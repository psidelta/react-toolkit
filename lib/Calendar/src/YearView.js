...
var bem = (0, _bemFactory2.default)('react-calendar__year-view');
...
var YearView = function (_Component) {
  ...
  _createClass(YearView, [{
    ...
    value: function renderMonths(props, months) {
      ...
      var className = this.props.rootClassName + '-row';
    ...
    value: function renderMonth(props, dateMoment) {
      ...
      var className = (0, _join2.default)(rootClassName + '-month', !disabled && isActiveDate && rootClassName + '-month--active', !disabled && isValue && rootClassName + '-month--value', disabled && rootClassName + '-month--disabled');
      ...
      return _react2.default.createElement(
        _Flex.Item,
        { key: monthText, className: className, onClick: onClick },
        monthText
      );
    }
  }, {
...
YearView.propTypes = {
  ...
  isYearView: _propTypes2.default.bool,
  constrainViewDate: _propTypes2.default.bool,
  onlyCompareMonth: _propTypes2.default.bool,
