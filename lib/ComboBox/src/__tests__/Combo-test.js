...
describe('Combo.js', function () {
  ...
  describe('collapseOnSelect', function () {
    it('collapses list when an item is selected', function () {
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_ComboBox2.default, { collapseOnSelect: true, defaultExpanded: true, dataSource: dataSource }));
  ...
  describe('clearTextOnBlur', function () {
    it('clears search text when combo recives blur', function () {
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_ComboBox2.default, { clearTextOnBlur: true, defaultText: 'hello world' }));
