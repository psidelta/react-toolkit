...
ImageFilePreview.propTypes = {
  defaultPreview: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.func, _react.PropTypes.object]),

  thumbSize: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.arrayOf(_react.PropTypes.number), _react.PropTypes.object]),

  file: _react.PropTypes.object,

  onReady: _react.PropTypes.func,
  fileReadAsDataUrl: _react.PropTypes.func
};
