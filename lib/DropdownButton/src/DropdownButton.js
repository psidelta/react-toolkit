...
var ZippyDropDownButton = function (_Component) {
  ...
  _createClass(ZippyDropDownButton, [{
    ...
    value: function renderButton() {
      ...
      }, _defineProperty(_extends2, 'icon', [(0, _react.cloneElement)(props.icon, { key: 'zippy-ddbuttonicon' }), this.renderArrow()]), _defineProperty(_extends2, 'children', props.children), _defineProperty(_extends2, 'tagName', 'div'), _extends2));
