...
describe('MessageWindow', function () {
  ...
  describe('type info', function () {
    it('renders correct icon and buttons', function () {
      ...
      expect(wrapper.find(_Buttons.OkButton)).toHaveLength(1);
      expect(wrapper.find(_Icons.InfoIcon)).toHaveLength(1);
    });
  });
  ...
  describe('type question', function () {
    it('renders correct icon and buttons', function () {
      ...
      expect(wrapper.find(_Buttons.YesButton)).toHaveLength(1);
      expect(wrapper.find(_Buttons.NoButton)).toHaveLength(1);
      expect(wrapper.find(_Icons.QuestionIcon)).toHaveLength(1);
    });
  });
  ...
  describe('type error', function () {
    it('renders correct icon and buttons', function () {
      ...
      expect(wrapper.find(_Buttons.OkButton)).toHaveLength(1);
      expect(wrapper.find(_Icons.ErrorIcon)).toHaveLength(1);
    });
  });
});